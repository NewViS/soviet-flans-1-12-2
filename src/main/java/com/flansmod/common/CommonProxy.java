...
public class CommonProxy
{
	...
	public Container getServerGui(int ID, EntityPlayer player, World world, int x, int y, int z)
	{
		switch(ID)
		{
			...
			case 4: return new ContainerDriveableMenu(player.inventory, world, true, false, ((EntitySeat)player.getRidingEntity()).driveable);
			...
			case 8: return new ContainerDriveableMenu(player.inventory, world, true, false, ((EntitySeat)player.getRidingEntity()).driveable);
			...
			case 14: return new ContainerDriveableMenu(player.inventory, world, false, true, ((EntitySeat)player.getRidingEntity()).driveable);
